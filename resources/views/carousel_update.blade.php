    ...
    <div class="row">
        ...
        <div class="col-lg-8 mb-4">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <div class="row">
                        <h6 class="m-0 font-weight-bold text-primary">Carousel Update</h6>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('carousel_update_process') }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="note" class="form-control" required id="" cols="30" rows="10">{{ $carousel->Note }}</textarea>
                            </div>
                            <div class="col-md-12">
                                <br />
        ...
        <div class="col-lg-4 mb-4">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <div class="row">
                        <h6 class="m-0 font-weight-bold text-primary">Carousel Image</h6>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('carousel_update_image') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
